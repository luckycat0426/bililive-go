...
// Source: github.com/luckycat0426/bililive-go/src/live (interfaces: Live)
...
import (
	...
	live "github.com/luckycat0426/bililive-go/src/live"
)
...
func (mr *MockLiveMockRecorder) GetUploadPath() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUploadPath", reflect.TypeOf((*MockLive)(nil).GetUploadPath))
}

// NeedUpload mocks base method.
func (m *MockLive) NeedUpload() bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NeedUpload")
	ret0, _ := ret[0].(bool)
	return ret0
}

// NeedUpload indicates an expected call of NeedUpload.
func (mr *MockLiveMockRecorder) NeedUpload() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NeedUpload", reflect.TypeOf((*MockLive)(nil).NeedUpload))
}
...
// SetUpload mocks base method.
func (m *MockLive) SetUpload(arg0 bool) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetUpload", arg0)
}

// SetUpload indicates an expected call of SetUpload.
...
func (m *MockLive) SetUploadPath(arg0 string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetUploadPath", arg0)
}

// SetUploadPath indicates an expected call of SetUploadPath.
func (mr *MockLiveMockRecorder) SetUploadPath(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetUploadPath", reflect.TypeOf((*MockLive)(nil).SetUploadPath), arg0)
}
